...
public class ArchivesManager {
    // Attributes
    // Dossier à Zipper
    public final String FolderToZip = "../DB/TempFileMedDoss";
    // fichierZip
    public final String ZipFile = "../DB/ArchivedMedDoss/Archives.zip";
    // Dossier de destination
    public final String dossierDestination = "../DB/RestoredMedDoss";

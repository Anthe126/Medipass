...
public class SystemDB {
    ...
    public SystemDB(boolean TableP, boolean TableU) {
        // If Patients and Utilisateurs only
        // No Admin
        this.Table = TableP;
        if (Table) {
    ...
    public void addRow() {
        ...
        if (Table) {    // Patients
            ...
            strow.add("4,Tello,Kotlyn,45,Feminin,12_11_2002,45347689,kotlyn706tello@gmail.com,London");
            strow.add("5,Deyara,Alicia,33,Feminin,01_11_2001,89067435,alicia10deydara@gmail.com,Vancouver");
            strow.add("6,Verrara,Ferdinand,21,Masculin,30_06_1993,98886732,ferdinand32verrara@gmail.com,Alaska");
            strow.add("7,Allman,Kris,31,Feminin,12_11_2002,45347689,kris209allman@gmail.com,Beverlly Hills");
            strow.add("8,Vampira,Alica,18,Feminin,30_03_1975,65789324,alica76vampira@gmail.com,Vietnam");
        } else {    // Utilisateurs
            ...
            strow.add("1,Brown,Britanie,22,Feminin,21_12_1990,90908976,britanie11brown@gmail.com,Gibraltar,Infirmier");
            strow.add("2,Cornnwell,Simphony,23,Feminin,28_07_1997,90876545,simphony@cornnwellgmail.com,Zair,Medecin");
            strow.add("3,Bill,Ditch,22,Masculin,23_01_1978,34546578,ditch90bill@gmail.com,Libye,Medecin");
            ...
            strow.add("6,Zyt,Aann,26,Feminin,21_12_1999,34900076,aann99zyt@gmail.com,Koweit,Medecin");
            strow.add("7,Hann, Sully,25,Feminin,21_12_1945,45234573,hann78sully@gmail.com,Beyrouth,Medecin");
            strow.add("8,Freudicth,Zeynan,45,Masculin,18_09_2001,89730990,zeynan67freudicth@gmail.com,Seoul,Medecin");
            strow.add("9,Gailto,Kagami,21,Feminin,21_12_1999,34900076,kagami78gailto@gmail.com,Singapour,Infirmier");
        }
    }
